...
//  BlueYappron
//
//  Created by Iain Whiteside on 11/20/17.
...
class RecipeStepTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cellIdentifier = "RecipeStepTableViewCell"
        ...
        //TO DO: parse ingred and quantity:
        //cell.ingredLabel.text = "HI"
        //cell.quantitiesLabel.text = step.time
